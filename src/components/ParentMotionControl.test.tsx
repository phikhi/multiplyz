...
it.each(["read", "write"])(
  "disables the preference honestly after a storage %s failure",
  (operation) => {
    vi.spyOn(Storage.prototype, operation === "read" ? "getItem" : "setItem").mockImplementation(
      () => {
