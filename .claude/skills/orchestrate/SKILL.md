...
5. Puis **clôturer l'épic** et revenir à l'étape 3. **Plus d'épic ni de story ouverte = fin de scope = sortie propre** → `node .claude/skills/orchestrate/concurrency-guard.mjs release` **avant** le rapport de complétion.
